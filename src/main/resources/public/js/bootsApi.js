...
const renderBootsListCallback = (bootsTableBody) => (boots) => {
    ...
    boots.forEach((boot) => {
      ...
      <td>${boot.quantity}</td>
      <td>
        <span class="increment-boot-icon" onclick="changeBootQuantity(${boot.id}, 'increment', renderBootsListCallback(document.getElementById('bootsTableBody')));">Increase</span>
        <span class="decrement-boot-icon" onclick="changeBootQuantity(${boot.id}, 'decrement', renderBootsListCallback(document.getElementById('bootsTableBody')));">Decrease</span>
        <span class="delete-boot-icon" onclick="deleteBootById(${boot.id}, renderBootsListCallback(document.getElementById('bootsTableBody')));">Delete</span>
      </td>
    `;
